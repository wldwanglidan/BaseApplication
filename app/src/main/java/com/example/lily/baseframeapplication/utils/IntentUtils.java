...
public class IntentUtils {
    ...
    public static Intent getInstallAppIntent(String filePath) {
        return getInstallAppIntent(com.example.lily.baseframeapplication.utils.FileUtils.getFileByPath(filePath));
    }
    ...
    public static Intent getShareImageIntent(String content, String imagePath) {
        return getShareImageIntent(content, com.example.lily.baseframeapplication.utils.FileUtils
    ...
    public static Intent getShareImageIntent(String content, File image) {
        if (!com.example.lily.baseframeapplication.utils.FileUtils.isFileExists(image)) return null;
